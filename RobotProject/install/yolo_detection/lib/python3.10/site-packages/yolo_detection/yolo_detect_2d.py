...
import yaml
import time
from yolo_detection.cv_tool import px2xy
import os
...
class YoloV5Ros2(Node):
    def __init__(self):
        ...
        self.declare_parameter("image_topic", "/camera/image_raw", ParameterDescriptor(
            name="image_topic", description="Image topic, default: /camera/image_raw"))
        ...
        self.declare_parameter("pub_result_img", True, ParameterDescriptor(
            name="pub_result_img", description="Whether to publish detection result images, default: True"))
    ...
    def image_callback(self, msg: Image):
        ...
        # 记录发布频率 
        self.get_logger().info(f'Image callback frequency: {1.0 / time_diff:.2f} Hz')
